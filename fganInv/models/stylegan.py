...
class Generator(nn.Module):
    def __init__(
        ...
        self.n_latent = self.log_size * 2 - 2 #2*8-2=14
    ...
    def forward(
        ...
        if len(styles) < 2:#len([batch,n_layers,512])=1        n_mlp,style_dim  origin:[bn,num_layers, G.w_space_dim]
            ...
            if styles[0].ndim < 3:
                ...
                latent = styles[0]#[bn,n_latent,style_dim]
...
if __name__=='__main__':
    ...
    # summary(G)
    # # D=Discriminator((512,384))
    # h=h_layers(256)
    # bs=16
    # summary(h,input_size=(bs,3,256,256))
